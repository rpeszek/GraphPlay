...
isValidMorphism :: forall g v0 e0 t v1 e1 . (Eq v0, Eq v1, DiEdgeSemantics e0 v0, DiEdgeSemantics e1 v1) =>
...
isValidMorphismSingleEdge :: forall g v0 e0 t v1 e1 . (Eq v0, Eq v1, DiEdgeSemantics e0 v0, DiEdgeSemantics e1 v1) =>
