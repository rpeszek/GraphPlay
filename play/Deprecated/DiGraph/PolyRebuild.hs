...
areEqual :: Bool
areEqual = diamond0123Simple ~>#== (diamond0123 :: HM.DiEdgesByVertexMap Int (OPair Int) [])    -- returns True
...
areNotEqual = diamond0123Simple ~>#== (diamondChain :: SG.SimpleListDiGraph Int)-- returns False
